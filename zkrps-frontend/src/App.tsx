...
import { ZkrpsGame } from './games/zkrps/ZkrpsGame';

const GAME_ID = 'rps-game';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'ZK RPS';
const GAME_TAGLINE = import.meta.env.VITE_GAME_TAGLINE || 'Commit, prove, and settle on Stellar';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_RPS_GAME_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
